...
@Slf4j
public class BlockingQueueXExecutor extends AbstractXExecutor {

    public BlockingQueueXExecutor() {
    ...
    public void shutdown() {
        ...
        log.error("blocking queue shutdown call");
        try {
